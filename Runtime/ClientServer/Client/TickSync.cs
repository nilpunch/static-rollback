...
namespace Shenanicode.Rollback {
	public class TickSync {
		...
		/// <summary>
		/// ApprovedSimulationTick + 1, basically this is the first tick that prediction can affect.
		...
		public virtual void HardReset(int minPredictionTick = 0) {
			MinPredictionTick = minPredictionTick;
